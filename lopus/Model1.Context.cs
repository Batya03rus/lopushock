...
namespace lopus
{
    ...
    public partial class lopuhEntities : DbContext
    {
        public lopuhEntities()
            : base("name=lopuhEntities")
        {
        }
        private static lopuhEntities _context;

        public static lopuhEntities GetContext()
        {
            if (_context == null) _context = new lopuhEntities();
            return _context;
        }
